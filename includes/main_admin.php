...
<div class="filmContainer row">
    ...
    ?>
            <div class="films_film col-xs-12 col-sm-6 col-md-4 col-lg-3">
                ...
                <div class="film_actions_delete_update">
                    <div class="button_action_group">
                        ...
                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#updateModal<?php echo $id_film; ?>">
                        ...
                        <button type="button" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $id_film; ?>" class="btn btn-danger">
            ...
            <div class="modal fade" id="updateModal<?php echo $id_film; ?>" tabindex="-1" aria-labelledby="updateModal" aria-hidden="true">
            ...
            <div class="modal fade" id="deleteModal<?php echo $id_film; ?>" tabindex="-1" aria-labelledby="deleteModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
